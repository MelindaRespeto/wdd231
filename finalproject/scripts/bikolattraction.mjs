...
export const bikolattraction = [
    {
        ...
        notableNearbyAttractions: [
            "Cagsawa Ruins — remnants of an 1814 church with views of Mayon Volcano",
            "Ligñon Hill Nature Park — panoramic views, zipline, and historic WWII tunnel",
            "Sumlang Lake — calm lake with Mayon reflections"
        ],
        activities: [
